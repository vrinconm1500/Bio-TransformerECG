...
class GetFeatures:
    ...
    def features(self, where, people):
        ...
        for person in people:
            ...
            elif self.where == "fantasia":
                files = ["data/raw/fantasia/" + person + ".csv"]
                
            elif self.where == "CYBHi":
    ...
    def segment(self, array):
        ...
        #peaks = ecg.christov_segmenter(signal=array, sampling_rate=1000)[0]
        peaks = ecg.ecg(signal=array, sampling_rate=1000., show=False,interactive=False)[2]
